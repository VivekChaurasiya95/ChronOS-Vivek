 ...
 * Use this file to manage all content across the website.
 */
...
export const siteConfig = {
  ...
  PHILOSOPHY: [
    { id: '01', title: 'Civic Impact', description: 'We focus on building tools that solve real-world governance and public access problems.', type: GeometryType.SQUARE },
    { id: '02', title: 'Open Source First', description: 'We believe in transparency, collaboration, and community-driven development.', type: GeometryType.CIRCLE },
    { id: '03', title: 'Responsible AI', description: 'We design AI systems that are ethical, explainable, and accessible.', type: GeometryType.TRIANGLE }
  ],
  ...
  CONTRIBUTE_PROTOCOLS: [
    ...
    },
    {
      ...
      href: 'https://github.com/ChronalLabs/discussions'
    },
    {
      number: "03",
      ...
      href: 'https://github.com/ChronalLabs/GSoC'
    },
    {
      number: "04",
      ...
      actionLabel: "CONNECT",
      href: 'https://discord.gg/chronallabs'
    }
  ]
};